...
The long version. The short version is the [README](README.md); the API
contract and patterns live in [AGENTS.md](AGENTS.md); the bug ledger and
the simulator that wrote it live in [bugs.md](bugs.md).
